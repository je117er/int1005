...
" The following are the examples of different formats supported.
" Keep plugins commands between vundle#begin/end.
...
"------------------------------------------------------------
"set make for c programs
set makeprg=make\ -C\ ../build\ -j9
" save and compile and run c programs:
